...
function sign(){
    ...
    if (x=="March" && (y>=21 && y<=31) || x=="April" && (y>=1 && y<=19) ){
        ...
        document.getElementById("trait").innerHTML="Incorrect Data...... Please check the entered date.";
    }
...
function traits(){
    ...
    if (x=="March" && (y>=21 && y<=31) || x=="April" && (y>=1 && y<=19) ){
        ...
        document.getElementById("sign").innerHTML="Incorrect Data...... Please check the entered date.";
    }
